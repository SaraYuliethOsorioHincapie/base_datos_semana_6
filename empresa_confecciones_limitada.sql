-- CREATE DATABASE `empresa_confecciones_limitada`; 

USE `empresa_confecciones_limitada`;
...
CREATE TABLE `oficina` (
  ...
  PRIMARY KEY (`codigOficina`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Data for the table `oficina` */

insert  into `oficina`(`codigOficina`,`ciudad`,`telefono`,`direccion1`,`direccion2`,`estado`,`pais`,`codigoPostal`,`territorio`) values 
...
CREATE TABLE `linea_producto` (
  ...
  `textoDescriptivo` varchar(4000) DEFAULT NULL,
  `htmlDescriptivo` mediumtext,
  `imagen` mediumblob,
  PRIMARY KEY (`lineaProducto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Data for the table `linea_producto` */

insert  into `linea_producto`(`lineaProducto`,`textoDescriptivo`,`htmlDescriptivo`,`imagen`) values 
...
CREATE TABLE `empleado` (
  ...
  CONSTRAINT `empleado_ibfk_1` FOREIGN KEY (`jefe`) REFERENCES `empleado` (`numeroEmpleado`),
  CONSTRAINT `empleado_ibfk_2` FOREIGN KEY (`codigOficina`) REFERENCES `oficina` (`codigOficina`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Data for the table `empleado` */

insert  into `empleado`(`numeroEmpleado`,`apellido`,`nombre`,`extension`,`correo`,`codigOficina`,`jefe`,`titulo`) values 
...
CREATE TABLE `cliente` (
  ...
  `contactoApellido1` varchar(50) NOT NULL,
  `telefono` varchar(50) NOT NULL,
  `direccion1` varchar(50) NOT NULL,
  `direccion2` varchar(50) DEFAULT NULL,
  `ciudad` varchar(50) NOT NULL,
  ...
  `pais` varchar(50) NOT NULL,
  `numeroEmpleadoVentas` int(11) DEFAULT NULL,
  `limiteDeCredito` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`numeroCliente`),
  KEY `numeroEmpleadoVentas` (`numeroEmpleadoVentas`),
  CONSTRAINT `cliente_ibfk_1` FOREIGN KEY (`numeroEmpleadoVentas`) REFERENCES `empleado` (`numeroEmpleado`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Data for the table `cliente` */

insert  into `cliente`(`numeroCliente`,`nombreCliente`,`contactoApellido`,`contactoApellido1`,`telefono`,`direccion1`,`direccion2`,`ciudad`,`estado`,`codigoPostal`,`pais`,`numeroEmpleadoVentas`,`limiteDeCredito`) values 
...
CREATE TABLE `pedido` (
  ...
  `fechaLimitEntrega` date NOT NULL,
  ...
  CONSTRAINT `pedido_ibfk_1` FOREIGN KEY (`numeroCliente`) REFERENCES `cliente` (`numeroCliente`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Data for the table `pedido` */

insert  into `pedido`(`numOrden`,`fechaOrden`,`fechaLimitEntrega`,`fechaEnvio`,`estado`,`comentarios`,`numeroCliente`) values 
...
(10165,'2003-10-22','2003-10-31','2003-12-26','Shipped','This order was on hold because cliente\'s credit limit had been exceeded. Order will ship when payment is received',148),
...
(10173,'2003-11-05','2003-11-15','2003-11-09','Shipped','Cautious optimism. We have happy cliente here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches',278),
...
(10260,'2004-06-16','2004-06-22',NULL,'Cancelled','Customer heard complaints from their cliente and called to cancel this order. Will notify the Sales Manager.',357),
...
(10279,'2004-08-09','2004-08-19','2004-08-15','Shipped','Cautious optimism. We have happy cliente here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches',141),
...
(10377,'2005-02-09','2005-02-21','2005-02-12','Shipped','Cautious optimism. We have happy cliente here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches',186),
...
CREATE TABLE `producto` (
  ...
  `lineaProducto` varchar(50) NOT NULL,
  `localizacionProducto` varchar(10) NOT NULL,
  `vendedorProducto` varchar(50) NOT NULL,
  `descripcionProducto` text NOT NULL,
  `cantidadEnInventario` smallint(6) NOT NULL,
  `precioDeCompra` decimal(10,2) NOT NULL,
  `MSRP` decimal(10,2) NOT NULL,
  PRIMARY KEY (`codigoProducto`),
  KEY `lineaProducto` (`lineaProducto`),
  CONSTRAINT `producto_ibfk_1` FOREIGN KEY (`lineaProducto`) REFERENCES `linea_producto` (`lineaProducto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Data for the table `producto` */

insert  into `producto`(`codigoProducto`,`nombreProducto`,`lineaProducto`,`localizacionProducto`,`vendedorProducto`,`descripcionProducto`,`cantidadEnInventario`,`precioDeCompra`,`MSRP`) values 
...
CREATE TABLE `detalle_pedido` (
  ...
  `numeroLineaOrden` smallint(6) NOT NULL,
  PRIMARY KEY (`numOrden`,`codigoProducto`),
  KEY `codigoProducto` (`codigoProducto`),
  CONSTRAINT `detalle_pedido_ibfk_1` FOREIGN KEY (`numOrden`) REFERENCES `pedido` (`numOrden`),
  CONSTRAINT `detalle_pedido_ibfk_2` FOREIGN KEY (`codigoProducto`) REFERENCES `producto` (`codigoProducto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Data for the table `detalle_pedido` */

insert  into `detalle_pedido`(`numOrden`,`codigoProducto`,`cantidadOrden`,`precio`,`numeroLineaOrden`) values 
...
CREATE TABLE `pagos` (
  `numeroCliente` int(11) NOT NULL,
  `numCheck` varchar(50) NOT NULL,
  `fechaDePago` date NOT NULL,
  `cantidad` decimal(10,2) NOT NULL,
  PRIMARY KEY (`numeroCliente`,`numCheck`),
  CONSTRAINT `pagos_ibfk_1` FOREIGN KEY (`numeroCliente`) REFERENCES `cliente` (`numeroCliente`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Data for the table `pagos` */

insert  into `pagos`(`numeroCliente`,`numCheck`,`fechaDePago`,`cantidad`) values 
